...
/**
 * This class stems from the TTC16 github repository https://github.com/martin-fleck/cra-ttc2016/tree/master
 */
public class CRAIndexCalculator {
	...
	static boolean checkAllClassesDifferentNames(ClassModel model) {
		...
		for (architectureCRA.Class clazz : model.getClasses()) {
	...
	static double calculateCoupling(architectureCRA.Class classSource, ClassModel model) {
		double couplingRatio = 0;
		for(architectureCRA.Class classTarget : model.getClasses()) {
	...
	static List<Attribute> getAttributesClass(architectureCRA.Class clazz){
	...
	static List<Method> getMethodsClass(architectureCRA.Class clazz) {
	...
	static int mai(architectureCRA.Class classSource, architectureCRA.Class classTarget){
		int mai = 0;
	...
	static int mmi(architectureCRA.Class classSource, architectureCRA.Class classTarget){
		int mmi = 0;
