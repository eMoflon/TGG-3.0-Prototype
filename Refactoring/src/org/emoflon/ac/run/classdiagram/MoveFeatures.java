...
public class MoveFeatures extends RefactoringCase<FullHiPEGtApi>{
	...
	protected void createAndRegisterOverlaps() {
		...
		moveAttributeW1Violation.registerOverlap(api.intactMethodAttributeDependency(), "fromClazz", "toClazz", "attribute");
		...
		moveMethodW2Violation.registerOverlap(api.movingMethodToOtherMethodWithoutCommonDependency(), "fromClazz", "toClazz", "fromMethod");

		moveAttributeW2Violation.registerOverlap(api.moveAttribute(), "fromClazz", "toClazz", "attribute");
		moveAttributeW2Violation.registerOverlap(api.moveLastCommonAttributeToOtherClass(), "fromClazz", "toClazz", "attribute");
