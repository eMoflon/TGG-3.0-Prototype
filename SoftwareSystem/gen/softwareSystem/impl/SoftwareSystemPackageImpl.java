...
public class SoftwareSystemPackageImpl extends SmartPackageImpl
	...
	private EAttribute system_testEAttribute = null;
	...
	@Override
	public EAttribute getSystem_Test() {
		return system_testEAttribute;	
	}
	@Override
	...
	public void createPackageContents() {
		...
		createEAttribute(systemEClass, SYSTEM__TEST);
		system_testEAttribute = (EAttribute) systemEClass.getEStructuralFeatures().get(3);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSystem_Test(), ecorePackage.getEString(),
			"test", null, 0, -1, System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
