...
public class SystemImpl extends SmartObject implements softwareSystem.System {
    ...
    protected java.lang.String test = null;
    ...
    public void setTest(java.lang.String value) {
    	Object oldValue = this.test;
    	this.test = value;
    	
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, SoftwareSystemPackage.Literals.SYSTEM__TEST, oldValue, value, -1));
    }
    ...
    public void eSet(EStructuralFeature eFeature, Object newValue){
    	...
    	if (SoftwareSystemPackage.Literals.SYSTEM__TEST.equals(eFeature)) {
    		setTest((java.lang.String) newValue); 
    		return;
    	}
